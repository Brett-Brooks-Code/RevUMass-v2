  ...
  export default  function Home() {
    ...
    return (
      <div>
        ...
        {/* Homepage */}
        <div className="bg-umass-black h-screen text-white flex-col justify-items-center content-center">
          <div className="relative w-3/5 h-8/10">
            ...
            <div className="h-1/20"></div>
            <div className="text-4xl text-neutral-gray shine-text">UMass Amherst&apos;s place to discover and share opinions regarding on-campus life.</div>
            <form className="text-4xl text-neutral-gray shine-text">   
